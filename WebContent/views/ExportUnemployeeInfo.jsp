...
<body>
	...
	<div class="container">
		<div class="row align-items-end">
			<form action="exportUnemployee" method="post"
				id="exportunemployeeForm" name="form">
				<div class="form-inline">
					<div class="row">
						...
						<div class='col-md-3'>
							<div class="form-group">
								<label style="width: 110px;">面接日:</label>
								<sx:datetimepicker name="regStartDate"
						...
						<s:if test="%{lstApplicantInfo.size()>0}">
							<s:iterator value="lstApplicantInfo" var="row" status="status">
								...
								<tbody id="myTable">
									<tr>
										<td><s:property
												value="interview.examinee.applicant.app_Check" /></td>
										<td><s:property value="interview.examinee.examinee_Pass" /></td>
										<td><s:property value="interview.interview_Pass" /></td>
										<td id="lstApplicantID"><s:property
												value="interview.examinee.applicant.exam_ID" /></td>
										<td><s:property
												value="interview.examinee.applicant.app_Name" /></td>
										<td><s:property
												value="interview.examinee.firstCompany.com_Sname" /></td>
										<td><s:property
												value="interview.examinee.secondCompany.com_Sname" /></td>
										<td><s:property
												value="interview.examinee.examinee_IQmark" /></td>
										<td><s:property
												value="interview.examinee.examinee_EQmark" /></td>
										<td><s:property value="interview.interview_Date" />
										<td><s:property value="interview.interview_StartTime" />
							                <img src="img/core-img/tide.jpg" width="8px" />
							                <s:property value="interview.interview_EndTime" /></td>
										<td><s:property value="interview.interview_Place" />
										<td><s:property value="interview.interviewer" />
										<td><s:property
												value="interview.examinee.applicant.app_Gender" /></td>
										...
										<td><s:property
												value="interview.examinee.applicant.app_Nrc" /></td>
										<td><s:property
												value="interview.examinee.applicant.app_PhNo" /></td>
									<%-- 	<td><s:property
												value="interview.examinee.applicant.app_Degree" /></td> --%>
										 <td>
										    <s:if test="interview.examinee.applicant.app_Education == 'Graduated'">
										        <s:property value="interview.examinee.applicant.app_Degree" />
										    </s:if>
										    <s:else>
										        <s:property value="interview.examinee.applicant.app_ACYear" />
										    </s:else>
										</td>
										<td><s:property
												value="interview.examinee.applicant.app_University" /></td>
										<td><s:property
												value="interview.examinee.applicant.app_CityofUniversity" /></td>
										<td><s:property
												value="interview.examinee.applicant.app_Email" /></td>
										<td><s:property
												value="interview.examinee.applicant.app_RegDate.toString()" /></td>
									</tr>
									<s:hidden name="lstApplicantID[%{#status.index}]"
										value="%{#row.interview.examinee.applicant.app_ID}" />
								</tbody>
							</s:iterator>
						</s:if>
					</table>
				...
				<div class="row" style="float: right;">
					<s:submit type="button" name="btn" value="Excel出力"
