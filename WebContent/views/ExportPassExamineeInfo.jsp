...
<section class="contact-area bg-gray section-padding">
	<div class="container">
		<div class="row align-items-end">
			<form action="exportPassExaminee" method="post" id="exportPassExamineeForm" name="form">
			<div class="form-inline">
                ...
                <s:if test="%{lstApplicantInfo.size()>0}">
					<s:iterator value="lstApplicantInfo" var="row" status="status">							 
						<tbody id="myTable">
						<tr>
							<td id="lstApplicantID"><s:property value="examinee.applicant.exam_ID" /></td>
							...
							<td><s:property value="examinee.applicant.app_PhNo" /></td>
							...
							<td><s:property value="examinee.applicant.app_University" /></td>
							<td><s:property value="examinee.applicant.app_CityofUniversity" /></td>
							<td><s:property value="examinee.applicant.app_Email" /></td>
							<td><s:property value="examinee.applicant.app_RegDate.toString()" /></td>
						</tr>
						<s:hidden name="lstApplicantID[%{#status.index}]"
										value="%{#row.examinee.applicant.app_ID}" />
						</tbody>
				</s:iterator>
				</s:if>
				</table>
