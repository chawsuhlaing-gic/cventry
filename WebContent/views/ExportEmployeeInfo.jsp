...
<section class="contact-area bg-gray section-padding">
	<div class="container">
		<div class="row align-items-end">
			<form action="exportEmployee" method="post" id="exportEmployeeForm" name="form">
				<div class="form-inline">
					...
					<div class='col-lg-3'>
						<div class="form-group">
								<label style="width: 110px;">採用会社名:</label>
								<s:if test="%{lstCompany.size()>0}">
								<s:select name="ddlCompany" list="lstCompany"
			...
			<div class='table-cont' id='table-cont'>			
                ...
                <s:if test="%{lstApplicantInfo.size()>0}">
							<s:iterator value="lstApplicantInfo" var="row" status="status">							 
								<tbody id="myTable">
						<tr>
							<td id="lstApplicantID"><s:property value="interview.examinee.applicant.exam_ID" /></td>
							<td><s:property value="interview.examinee.applicant.app_Name" /></td>
							<td><s:property value="interview.company.com_Sname" /></td>
							<td><s:property value="interview.examinee.examinee_IQmark" /></td>
							<td><s:property value="interview.examinee.examinee_EQmark" /></td>
							<td><s:property value="interview.interview_Date" /></td>
							...
							<td><s:property value="interview.interview_Place" /></td>
							<td><s:property value="interview.interviewer" /></td>
							<td><s:property value="interview.examinee.applicant.app_Gender" /></td>
							...
							<td><s:property value="interview.examinee.applicant.app_Nrc" /></td>
							<td><s:property value="interview.examinee.applicant.app_PhNo" /></td>
							<%-- <td><s:property value="interview.examinee.applicant.app_Degree" /></td> --%>
							 <td>
							...
							<td><s:property value="interview.examinee.applicant.app_University" /></td>
							<td><s:property value="interview.examinee.applicant.app_CityofUniversity" /></td>
							<td><s:property value="interview.examinee.applicant.app_Email" /></td>
							<td><s:property value="interview.examinee.applicant.app_RegDate.toString()" /></td>
