...
<script type="text/javascript">
	...
	function CheckSelect() {
		document.getElementById("app_form").action = "SuccessfulApplicantSelectAction";
	}

	function SubmitActionReset() {
		document.getElementById("app_form").action = "SuccessfulApplicantAction";
	}
</script>
</head>
<body>
	...
	<div id="users">
		<div class="container">
			<div class="row align-items-end">
				<form action="SuccessfulApplicantAction" id="app_form" method="post" name="form">
					...
					<div class="form-inline" style="width: 90%;">
						...
						<div class="row">
							...
							<div class="col-sm-3"> 
								<label>受験者人数  :<span style="margin-left: 10px;"><s:property value="count" /></span></label>
							</div>
					...
					<div class="grid-container">
						...
						<ul class="list">
							<s:iterator value="Examineelist" status="stat">
								<s:if test="examinee_Pass.charAt(0) == 'Y'">
								...
								<li class="list--list-item"><s:checkbox
										fieldValue="%{applicant.exam_ID}" name="CheckedIDList"
										id="checkcount" theme="simple" value="YesOrNo" /><label
									class="search"> <s:property value="applicant.exam_ID" /></label></li>
							</s:iterator>
						</ul>
						<s:else>
						...
						<div class="col-sm-12">
							<span class="pull-right"> 
								<button type="submit" value="保存" name="btn"
									class="btn btn-primary" style="width: 100px;margin-left: 25%;" onclick="CheckSelect();">保存</button>
							</span>
						</div>
					</div>
					<!-- Modal -->
					...
					<div class="modal fade" id="basicExampleModal" tabindex="-1"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<s:if test="checkedExamineeList.size()>0">
									<div class="row">
										<div class="panel panel-default panel-table"
											...
											<tr>
												...
												<th>NRC</th>
													...
													<tbody>
														<s:iterator value="checkedExamineeList" status="stat">
															<tr id="t2">
